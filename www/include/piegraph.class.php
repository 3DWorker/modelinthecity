...
class PieGraph
{
	...
	*/
    function PieGraph($w=200, $h=150, $data,$id)
    {$this->id=$id;
	...
	*/
	function setColors($colors, $bg="E4E4E4", $text="000000", $border="999999")
	{
	...
	*/
    function display()
    {
		...
		for($i=$this->start_3d;$i > $this->cy; $i--)
		{
			...
			{
				if($data[0]=="0360"){$u=-1;}else{$u=0;}
				$col = $this->get_color($k+$u, "3d");
