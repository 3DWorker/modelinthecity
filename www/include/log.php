...
if($online>1){$s_notlog="s";}else{$s_notlog="";}

if($nblog>1){$s_log="s";}else{$s_log="";}
...
// Affichage
echo "<tr><td class=bleu>&nbsp;<b><font size=1>$online visiteur$s_notlog</b><br>";
echo "&nbsp;<b>$nblog membre$s_log</b></td></tr>"; 
