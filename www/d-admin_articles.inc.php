...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="admin_table">
    ...
    <tr id=admin_table_info><td align=center><font color=white><?php echo TEXT_ADMIN_CREATE_ARTICLE;?></font></td></tr><tr>
    <TD height="100%" id="admin_table_info_in" width=770 align=left> 
<div align=center><?php echo TEXT_ADMIN_SELECT_TEMPLATE;?>
...
<tr><td colspan=2 style="border:1px solid white;"><textarea cols=105 rows=2 class="admin_article_colone2">2</textarea></td></tr>
	...
	if($tpl==3){
?> 			<div align=center>Edition
			<table border=1 cellpadding=10 cellspacing=5 width=730 style="border:1px solid black;background:url(images/bg_admin_article.jpg);" id="admin_article_header">
	<tr style="border:1px solid white;"><td style="border:1px solid white;" colspan=2><input type="text" name="article_title" class="admin_article_title" value="TITLE OF THE ARTICLE" style="width:98%;height:30px;font-size:18px;text-align:center;"></td></tr>
	
	<tr style="border:1px solid white;"><td style="border:1px solid white;" align=right width=51%> <div style="border:2px dotted black; width:100%;height:306px;border-radius:8px;-moz-border-radius:8px;-webkit-border-radius:8px;text-align:center;background:white;margin-left:10px;"><br><br><br><br><br><br><br><br><br><input type=file name=encart size=15></div></td><td valign=top style="border:1px solid white;"> <textarea cols=48 rows=16  class="admin_article_colone">1</textarea> </td></tr>
	
<tr><td colspan=2 style="border:1px solid white;"><textarea cols=100 rows=17 class="admin_article_colone2">2</textarea></td></tr></table>
</div>
	<?
	}
	...
	if($tpl==4){
?> 			<div align=center>Edition
			<table border=1 cellpadding=5 cellspacing=5 width=730 style="border:1px solid black;background:url(images/bg_admin_article.jpg);" id="admin_article_header">
	<tr style="border:1px solid white;"><td style="border:1px solid white;" colspan=3><input type="text" name="article_title" class="admin_article_title" value="TITLE OF THE ARTICLE" style="width:98%;height:30px;font-size:18px;text-align:center;"></td></tr>
	
	<tr><td style="border:1px solid white;"> <textarea cols=35 rows=45  class="admin_article_colone">1</textarea> </td><td style="border:1px solid white;"> <div style="border:2px dotted black; width:120px;height:170px;border-radius:8px;-moz-border-radius:8px;-webkit-border-radius:8px;text-align:center;background:white;"><br><br><br><br><br><br><br><br><br><input type=file name=encart size=1></div> </td><td style="border:1px solid white;"> <textarea cols=35 rows=45  class="admin_article_colone2">2</textarea> </td></tr></table></div>
	<?
	}?>
