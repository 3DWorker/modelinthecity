...
}else{$ermes.="/!\ Alias must contains at least 3 chars<br>";$verif=0;$err_pseudo=1;$pseudo="";}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
          <td width="100%" height="24"> 
		            <div align="center"><font face="Arial, Helvetica, sans-serif"  size="3"><b>EMAIL SENT !</b></font></div>
          </td>
        </tr>
        <tr> 
          <td width="100%" height="74"> 
            <div align="center"> <font face="Arial, Helvetica, sans-serif" size="3"><br>
             <br><br> <b>You will receive an email of confirmation within few minutes ...
<br><br><br>Please activate the link in this email to conclude your membership !</b></font><br><br><br><font color=orange face="Arial, Helvetica, sans-serif" size="3"><b>/!\ If you don't receive this email within 10 minutes,<br>please check your spambox and allow the domain ModelinThecity.com to mail you.</b></font></div>
          </td>
        </tr>
      </table>
<?
...
<body topmargin=0 rightmargin=0 bottommargin=0 class=loginbox><br><br><br><br><br>
  <form method="post" action="signin.php?action=send">
    ...
    <TR> 
      <TD  align=center height="177" colspan=2> <br>
        <table cellpadding="0" cellspacing="5" border="0" width=100% class=loginbox>
          ...
          <tr> 
 <td align=right  height="22">Alias :</td>
            <td height="22" width="14%" > 
        
                <input type="text" class=input name="pseudo" size=10 maxlength=25 value="<?php echo $pseudo;?>" <?php if($err_pseudo){echo "style='background:yellow;';";}?>>

            </td>
            <td height="22">&nbsp;<input type=submit value="check" name="submiter" title="Check availability"><?php if(!$err_pseudo && $pseudo){echo $yes;}?></td>
			
   </tr><tr>
            <td align=right height="38"><nobr>E-mail :</nobr></td>
            <td  height="38" colspan=2>
      ...
      By clicking the “SIGN UP" button, I certify that I have read and agree to the <a href="./conditions.php" target="_blank">ModelinThecity Terms of service.</A></font>
               <br><br>
                <a href="#" onclick="document.forms[0].submit();"><div class=button_blue>SIGN UP</div></A><br><hr>The New Model Social Network.
            </td>
          </tr>
		    <?
